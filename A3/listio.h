...
/*********************************************************************
 * NAME: argValidate
 * PURPOSE: This function checks if the user enters appropriate command
 * line arguments
 * ARGUMENTS: Accepts command line arguements, it expects an executable
 * and a file
 * PRECONDITIONS: Command line arguments are entered
 * POSTCONDITIONS: None.
 *********************************************************************/
